static void X(hp_map2alm) (int nside, int lmax, int mmax, FLT *map,
  ...
  hpsharp_execute(SHARP_MAP2ALM,0,&alm,&map,ginfo,ainfo,1,FLAG,NULL,NULL);

  hpsharp_destroy_alm_info(ainfo);
...
static void X(hp_map2alm_pol) (int nside, int lmax, int mmax, FLT *map,
  ...
  hpsharp_execute(SHARP_MAP2ALM,0,&alm,&map,ginfo,ainfo,1,FLAG,0,0);
  mapptr[0]=map+npix; mapptr[1]=map+2*npix;
  almptr[0]=alm+2; almptr[1]=alm+4;
  hpsharp_execute(SHARP_MAP2ALM,2,&almptr[0],&mapptr[0],ginfo,ainfo,1,FLAG,0,0);
...
static void X(hp_map2alm_spin) (int nside, int lmax, int mmax, int spin,
  ...
  hpsharp_execute(SHARP_MAP2ALM,spin,&almptr[0],&mapptr[0],ginfo,ainfo,1,FLAG,0,0);
...
static void X(hp_alm2map_pol) (int nside, int lmax, int mmax, FLT *alm,
  ...
  mapptr[0]=map+npix; mapptr[1]=map+2*npix;
  almptr[0]=alm+2; almptr[1]=alm+4;
  hpsharp_execute(SHARP_ALM2MAP,2,&almptr[0],&mapptr[0],ginfo,ainfo,1,FLAG,0,0);
...
static void X(hp_alm2map_spin) (int nside, int lmax, int mmax, int spin,
  ...
  mapptr[0]=map; mapptr[1]=map+npix;
  almptr[0]=alm; almptr[1]=alm+2;
  hpsharp_execute(SHARP_ALM2MAP,spin,&almptr[0],&mapptr[0],ginfo,ainfo,1,FLAG,0,0);
