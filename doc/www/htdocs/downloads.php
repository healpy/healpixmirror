...
<LI><A NAME="tex2html_340_33"
  HREF="#SECTION_340_10000000000000000">Bug corrections and Improvements in Version 3.40</A>
<UL>
<LI><A NAME="tex2html_340_34"
  HREF="#SECTION_340_11000000000000000">General</A>
<LI><A NAME="tex2html_340_35"
  HREF="#SECTION_340_12000000000000000">C++</A>
<LI><A NAME="tex2html_340_36"
  HREF="#SECTION_340_13000000000000000">Fortran</A>
<LI><A NAME="tex2html_340_37"
  HREF="#SECTION_340_14000000000000000">IDL</A>
<LI><A NAME="tex2html_340_38"
...
<h3><A NAME="SECTION_340_10000000000000000">
Bug corrections and Improvements in Version 3.40</A>
</h3>
<P>

<h4><A NAME="SECTION_340_11000000000000000">
General</A>
</h4>
<UL><LI>
...
The weights for power-of-2 values of <SPAN CLASS="MATH"><I>N</I><SUB><I>side</I></SUB></SPAN> in <!-- MATH
 $\{16,...,2048\}$
 -->
<SPAN CLASS="MATH">{16,...,2048}</SPAN> are precomputed and shipped in <A NAME="tex2html_340_1"
  HREF="https://sourceforge.net/p/healpix/code/HEAD/tree/trunk/data"><TT>Healpix/data/weight_pixel_n?????.fits</TT></A>, and the missing ones can be computed for any value of <SPAN CLASS="MATH"><I>N</I><SUB><I>side</I></SUB></SPAN> with the <TT>compute_weights</TT> C++ facility.
</UL>
<A HREF=#top>    Back to Top</A><br><br>

<P>

<h4><A NAME="SECTION_340_12000000000000000"></A>
<BR>
<A NAME="tex2html_340_2"
  HREF="./html/index_cxx.htm">C++</A>
</h4>
<UL><LI>
 IMPORTANT: the syntax for specifying ring weights and pixel windows has
  changed! This affects the facilities <TT>anafast_cxx</TT>, <TT>smoothing_cxx</TT>,
  <TT>udgrade_harmonic_cxx</TT>, <TT>alm2map_cxx</TT>, <TT>mult_alm_cxx</TT>.
  Pixel window files have to be specified (with path) using the parameter
  <TT>windowfile</TT>; <TT>ringweights</TT> is used for ring weight files, and <TT>pixelweights</TT>
  for pixel weight files.
<LI>
 Full pixel quadrature weights are now supported in map analysis facilities such as <TT>anafast_cxx</TT>, <TT>smoothing_cxx</TT> and <TT>udgrade_harmonic_cxx</TT>
  using the <TT>pixelweights</TT> parameter.
<LI>
 Experimental <TT>needlet_tool</TT> code for needlet analysis
</UL>
<A HREF=#top>    Back to Top</A><br><br>

<P>

<h4><A NAME="SECTION_340_13000000000000000">
Fortran 90 </A><A NAME="tex2html_340_3"
  HREF="./html/facilities.htm">facilities</A>
and
	<A NAME="tex2html_340_4"
  HREF="./html/subroutines.htm">subroutines</A>
</h4>
<UL><LI>
 The facilities 
<A NAME="tex2html_340_5"
  HREF="./html/fac_anafast.htm"><TT>anafast</TT></A>
and 
<A NAME="tex2html_340_6"
  HREF="./html/fac_smoothing.htm"><TT>smoothing</TT></A>
now support pixel-based quadrature weights.
Introduction of the supporting 
<A NAME="tex2html_340_7"
  HREF="./html/sub_nside2npweights.htm"><TT>nside2npweights</TT></A>,
<A NAME="tex2html_340_8"
  HREF="./html/sub_unfold_weightsfile.htm"><TT>unfold_weightsfile</TT></A>,
<TT>get_healpix_weight_file</TT>,
<TT>get_healpix_pixel_weight_file</TT>.
<LI>
 The subroutine 
<A NAME="tex2html_340_9"
  HREF="./html/sub_input_map.htm"><TT>input_map</TT></A>
in its default mode
and the facilities 
<A NAME="tex2html_340_10"
  HREF="./html/fac_anafast.htm"><TT>anafast</TT></A>,
<A NAME="tex2html_340_11"
  HREF="./html/fac_median_filter.htm"><TT>median_filter</TT></A>,
<A NAME="tex2html_340_12"
  HREF="./html/fac_smoothing.htm"><TT>smoothing</TT></A>, and
<A NAME="tex2html_340_13"
  HREF="./html/fac_ud_grade.htm"><TT>ud_grade</TT></A>
test the value of the <TT>POLCCONV</TT> FITS keyword when reading a polarized map,
and interpret the polarization accordingly, 
as described in the note on POLCCONV in <A NAME="tex2html_340_14"
  HREF="./html/intro.htm">The <b>HEALPix</b> Primer</A>.
<LI>
 <A NAME="tex2html_340_15"
  HREF="./html/fac_median_filter.htm"><TT>median_filter</TT></A>
facility and 
<A NAME="tex2html_340_16"
  HREF="./html/sub_median.htm"><TT>median</TT></A>
subroutine: faster by moving an internal array from heap to stack; do not crash anymore when dealing with empty data sets; 
slightly different output of <A NAME="tex2html_340_17"
  HREF="./html/fac_median_filter.htm"><TT>median_filter</TT></A>: when median is computed over an even number of pixels <SPAN CLASS="MATH"><IMG
...
<h4><A NAME="SECTION_340_14000000000000000"></A>
<BR>
<A NAME="tex2html_340_18"
  HREF="./html/idl.htm">IDL</A>
</h4>
<UL><LI>
 The routines <A NAME="tex2html_340_19"
  HREF="./html/idl_ianafast.htm"><TT>ianafast</TT></A>
and <A NAME="tex2html_340_20"
  HREF="./html/idl_ismoothing.htm"><TT>ismoothing</TT></A>
can now use pixel-based quadrature weights. Addition of the supporting functions 
<A NAME="tex2html_340_21"
  HREF="./html/idl_nside2npweights.htm"><TT>nside2npweights</TT></A>
and
<A NAME="tex2html_340_22"
  HREF="./html/idl_unfold_weights.htm"><TT>unfold_weights</TT></A>.
<LI>
 <A NAME="tex2html_340_23"
  HREF="./html/idl_ianafast.htm"><TT>ianafast</TT></A>
and <A NAME="tex2html_340_24"
  HREF="./html/idl_ismoothing.htm"><TT>ismoothing</TT></A>: 
see note on <TT>POLCCONV</TT> in F90 facilities above.
<LI>
 
<A NAME="install:idl:change_polcconv"></A>install:idl:change_polcconv
<A NAME="tex2html_340_25"
  HREF="./html/idl_change_polcconv.htm"><TT>change_polcconv</TT></A>
has been improved to allow the change of 
polarization convention (by changing the sign of <SPAN CLASS="MATH"><I>U</I></SPAN> Stokes parameter and updating <TT>POLCCONV</TT> value) in FITS files 
containing polarized maps generated by standard <b>HEALPix</b> tools, 
as well as for specific formats brewed by the WMAP and Planck projects throughout the years.
<LI>
 New <A NAME="tex2html_340_26"
  HREF="./html/idl_help_st.htm"><TT>help_st</TT></A>
to get information on a structure and its sub-structures
<LI>
 <A NAME="tex2html_340_27"
  HREF="./html/idl_mollview.htm"><TT>azeqview, cartview, gnomview, mollview, orthview</TT></A>
visualization routines:
  <UL><LI>
 addition of the keywords 
	<TT>CUSTOMIZE</TT> and 
	<TT>DEFAULT_SETTINGS</TT>
	for extensize customization of the figures produced
    <LI>
 <TT>GLSIZE</TT> and
	<TT>IGLSIZE</TT> can now be 2-element vectors to control separately the size
	(and presence) of labels on the parallel and meridian graticules
   <LI>
 fine control of polarisation rods thickness with <TT>POLARIZATION</TT>
   <LI>
 addition of the <TT>SILHOUETTE</TT> keyword to add a tunable silhouette around the projected map (<A HREF="#idl:mollview"><TT>mollview</TT> and <TT>orthview</TT> only</A>)
  </UL>
<LI>
 Improved support for GDL and FL (Fawlty Language).
<LI>
 Update of the required
    <A NAME="tex2html_340_28"
  HREF="https://idlastro.gsfc.nasa.gov/homepage.html"><TT>IDL-astron</TT> library</A>
routines, and <A NAME="tex2html_340_29"
...
<h4><A NAME="SECTION_340_15000000000000000"></A>
<BR>
<A NAME="tex2html_340_30"
  HREF="https://healpy.readthedocs.org/en/latest/">Python</A>
</h4>
<UL><LI>
 Switch to 
	<A NAME="tex2html_340_31"
  HREF="https://github.com/healpy/healpy/releases"><TT>healpy 1.12.0 </TT></A>
(<A NAME="tex2html_340_32"
  HREF="https://github.com/healpy/healpy/blob/master/CHANGELOG.rst">CHANGELOG</A>)
<LI>
 Addition of the python facility <TT>src/python/change_polcconv.py</TT> to change the polarization convention 
(see <A HREF="#install:idl:change_polcconv">IDL's <TT>change_polcconv.pro</TT> above</A>).
</UL>
<A HREF=#top>    Back to Top</A><br><br>
