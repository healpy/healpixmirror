...
<UL>
<LI><A NAME="tex2html_330_14"
  HREF="#SECTION_330_11000000000000000">C++</A>
<LI><A NAME="tex2html_330_15"
  HREF="#SECTION_330_12000000000000000">Fortran</A>
<LI><A NAME="tex2html_330_16"
  HREF="#SECTION_330_13000000000000000">IDL</A>
<LI><A NAME="tex2html_330_17"
  HREF="#SECTION_330_14000000000000000">Java</A>
<LI><A NAME="tex2html_330_18"
...
<h4><A NAME="SECTION_330_11000000000000000"></A>
<BR>
<A NAME="tex2html_330_1"
  HREF="http://healpix.sourceforge.net/html/index_cxx.htm">C++</A>
</h4>
...
<LI>allow generation of <SPAN CLASS="MATH"><I>a</I><SUB><I>lm</I></SUB></SPAN> from 6-component power spectra;
</LI>
<LI>moved from <TT>alice2</TT> to <TT>alice3</TT>, which produces FITS HEALPix maps as output.
 These can be visualized more flexibly with external tools.
</LI>
<LI>switch from custom <TT>xcomplex</TT> class to <TT>std::complex</TT>;
</LI>
<LI><TT>rangeset</TT> class has been redesigned.
</LI>
</UL>
<A HREF=#top>    Back to Top</A><br><br>
...
<h4>Fortran 90 <A NAME="tex2html_330_2"
  HREF="http://healpix.sourceforge.net/html/facilities.htm">facilities</A>
and
	<A NAME="tex2html_330_3"
  HREF="http://healpix.sourceforge.net/html/subroutines.htm">subroutines</A>
</h4>

<UL>
<LI><TT>anafast</TT> facility now produces nine spectra 
	(TT, EE, BB, TE, TB, EB, ET, BT and BE), instead of six previously,
          when analyzing two polarized maps;
</LI>
<LI><TT>alm2cl</TT> subroutine can now produces nine spectra 
      (TT, EE, BB, TE, TB, EB, ET, BT and BE), instead of six previously, when 
      called with two sets of polarized <SPAN CLASS="MATH"><I>a</I><SUB><I>lm</I></SUB></SPAN> and can also symmetrize 
      the output <SPAN CLASS="MATH"><I>C</I>(<I>l</I>)</SPAN> if requested;
</LI>
<LI>the <SPAN CLASS="MATH"><I>a</I><SUB><I>lm</I></SUB></SPAN> generated by 
	<TT>create_alm</TT> subroutine can now take into account
 non-zero (exotic) TB and EB cross-spectra (option <TT>polar=2</TT>) if the input FITS file contains the relevant information
</LI>
<LI>new routines <TT>nest2uniq</TT> 
	and <TT>uniq2nest</TT> for conversion 
	of standard pixel index to/from Unique ID number. See ''The Unique Identifier scheme'' section in <A NAME="tex2html_330_4"
  HREF="http://healpix.sourceforge.net/html/intro.htm">''HEALPix Introduction Document''</A>
for more details.
</LI>
<LI>improved 
<TT>repeat</TT>
...
<h4><A NAME="SECTION_330_13000000000000000"></A>
<BR>
<A NAME="tex2html_330_5"
  HREF="http://healpix.sourceforge.net/html/idl.htm">IDL</A>
</h4>

<UL>
<LI><TT>azeqview, cartview, gnomview, mollview, orthview</TT> 
visualization routines:
 
<UL>
<LI>addition of <TT>PDF</TT> keyword for production of Adobe PDF outputs;
</LI>
<LI>addition of <TT>LATEX</TT> keyword for genuine 
 or emulated <SPAN CLASS="logo,LaTeX">L<SUP><SMALL>A</SMALL></SUP>T<SMALL>E</SMALL>X</SPAN> processing of character strings;
</LI>
<LI>addition of <TT>PFONTS</TT> keyword to select 
origin and type of character font;
</LI>
<LI>the <TT>CROP</TT> keyword now has the same behavior for all output media (GIF, JPEG, PDF, PNG, PS, ... and X);  the <TT>NOBAR</TT> keyword now removes the color bar <EM>or</EM> the polarization color wheel, as applicable; correct EQUINOX date in header of output FITS map; the double precision maps and those with constant value are now correctly handled.
 
</LI>
</UL>
</LI>
<LI><TT>fits2cl</TT>: addition of <TT>/PLANCK2</TT> keyword
to read best fit <SPAN CLASS="MATH"><I>C</I>(<I>l</I>)</SPAN> model to Planck 2015 data.
</LI>
<LI>new routines <TT>nest2uniq</TT> and <TT>uniq2nest</TT> for conversion of standard pixel index to/from Unique ID number. See ''The Unique Identifier scheme'' section in <A NAME="tex2html_330_6"
  HREF="http://healpix.sourceforge.net/html/intro.htm">''HEALPix Introduction Document''</A>
for more details.
</LI>
<LI>HEALPix enabled GDL commands (<TT>hgdl</TT> and  <TT>hgdlde</TT>) are defined during the 
...
<h4><A NAME="SECTION_330_14000000000000000"></A>
<BR>
<A NAME="tex2html_330_9"
  HREF="http://healpix.sourceforge.net/html/java/index.html">Java</A>
</h4>
...
<LI>new targets in <TT>build.xml</TT> which allow compilation without external JARs.
</LI>
</UL>
<A HREF=#top>    Back to Top</A><br><br>
...
<h4><A NAME="SECTION_330_15000000000000000"></A>
<BR>
<A NAME="tex2html_330_11"
  HREF="http://healpy.readthedocs.org/en/latest/">Python</A>
</h4>

<UL>
<LI>switch to <A NAME="tex2html_330_12"
  HREF="https://github.com/healpy/healpy/releases"><TT>healpy
1.9.0</TT></A>
<UL>
<LI>same C++ source code as HEALPix 3.30
</LI>
<LI>drop support for Python 2.6
</LI>
<LI>support for <TT>astropy.fits</TT>
</LI>
<LI>improvements to  <TT>read_map</TT> and <TT>write_map</TT> 
</LI>
<LI>renamed <TT>get_neighbours</TT> to <TT>get_interp_weights</TT>
</LI>
