...
\subsubsection[General]{General}
	\begin{itemize}
	\item Generation of {\tt pkg-config} files during the configuration of the
C, C++ and F90 packages. 
See Section~\ref{sec:pkg-config} of 
\linklatexhtml{''\healpix\ Installation''}{install.pdf}{install.htm} for details.
	\end{itemize}
\subsubsection[C]{\linklatexhtml{C}{csub.pdf}{csub.htm}}
\subsubsection[C++]{C++}
\subsubsection[Fortran]{%
...
See Section~\ref{sec:freef90compilers} of \linklatexhtml{''\healpix\ Installation''}{install.pdf}{install.htm} for details.
