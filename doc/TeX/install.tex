...
or
the Fawlty Language \textbf{FL}, a {\em free closed} clone of IDL 8, 
...
GDL \gdlversion or more         & \htmladdnormallink{{\tt
			...
			http://sourceforge.net/projects/gnudatalanguage}
                                                      \\ %%% for presentation
FL \flversion or more         & \htmladdnormallink{{\tt
...
GDL v0.9.7 released on Jan 2017 and may be solved in subsequent versions. Please send all your questions
...
\item When run under GDL 0.9.7, and if the requirements stated above are met, 
...
Fawlty Language (FL) is a black-box implementation of IDL 8, for which precompiled self-contained packages
