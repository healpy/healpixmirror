...
the \healpix {\tt pkgconfig} files above are known to it (either by moving/copying them
...
\end{itemize}
\item with Xquartz (default under Moutain Lion (10.8.*)):\\
...
the free Fortran95 compiler \textbf{g95} (\htmladdnormallink{http://www.g95.org/}{http://www.g95.org/})
...
\subsubsection[IDL]{\linklatexhtml{IDL}{idl.pdf}{idl.htm}}
\begin{itemize}
\item addition of \htmlref{{\tt ialteralm}}{{idl:ialteralm}}

\item \htmlref{{\tt cartview, gnomview, mollview,
orthview}}{idl:mollview}: addition of  
...
1.7.0}}{https://github.com/healpy/healpy/releases} 
	\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% END LATEST CHANGES %%%%%%%%%%%%%
\subsection{Bug corrections and Improvements in Version 3.11 (2013-04)} 
...
\subsection{Bug corrections and Improvements in Version 3.10 (2013-03)}
\subsubsection[General]{General}
N/A%
\subsubsection[C]{\linklatexhtml{C}{csub.pdf}{csub.htm}}
%
...
{\em \mytargetb{install:cpp:gccreleases}{Note} that 
