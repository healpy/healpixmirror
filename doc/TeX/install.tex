...
is enabled (possibly requiring the flag \texttt{-fopemp=libomp} instead of the usual \texttt{-fopemp}
...
\subsection{Bug corrections and Improvements in Version \hpxversion}%2020-07-24
...
%	\linklatexhtml{IDL}{idl.pdf}{idl.htm}}
\begin{itemize}
   \item Addition of 
...
% ------
%----------------------------------------------------
\section{Appendix II: Older changes (versions 3.00 to 3.60)}
%
{\mytiny{%
%
