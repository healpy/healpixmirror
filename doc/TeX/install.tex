...
The weights for power-of-2 values of $\nside$ in $\{16,\ldots,2048\}$ are precomputed and shipped in \htmladdnormallink{\texttt{Healpix/data/weight\_pixel\_n?????.fits}}{http://sourceforge.net/p/healpix/code/HEAD/tree/trunk/data}, and the missing ones can be computed for any value of $\nside$ with the \texttt{compute\_weights} C++ facility.
