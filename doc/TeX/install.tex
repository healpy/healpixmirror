...
\htmladdnormallink{https://sourceforge.net/p/healpix/wiki/Windows\%20and\%20peazip/}{https://sourceforge.net/p/healpix/wiki/Windows\%20and\%20peazip/}} \hfill\newline
%\begin{verbatim}
...
are performed with the higly optimized C-written \texttt{libsharp} library, 
...
\textbf{IDL}
Astronomy User's Library (\htmladdnormallink{\texttt{https://idlastro.gsfc.nasa.gov/homepage.html}}{https://idlastro.gsfc.nasa.gov/homepage.html})
or the COBE (IDL) Analysis Software (\htmladdnormallink{\texttt{https://lambda.gsfc.nasa.gov/product/cobe/cgis.cfm}}{https://lambda.gsfc.nasa.gov/product/cobe/cgis.cfm}),
...
\texttt{IPython} (\htmladdnormallink{\texttt{https://ipython.org}}{https://ipython.org})
and 
\texttt{Cython} (\htmladdnormallink{\texttt{https://cython.org}}{https://cython.org})
...
Starting with version 3.60, if the environment variables 
      \texttt{FITSDIR, FITSINC},  (relevant for C/C++/F90/python),
      \texttt{CC, CXX},           (C/C++/F90/python),
...
Starting with version 3.60, the interactive configure script will be used to
...
The configuration of \texttt{libsharp} will be also taken care at this stage.\\
At odds with previous versions, the C++ binaries, libraries and header files will be installed in the \texttt{bin}, \texttt{lib} and \texttt{include} directories respectively.
\\
...
The libsharp library for optimized Spherical Harmonics operations, 
is used by the C++, Fortran and healpy packages. 
It will be configured (only once) at the same time as any of these packages,
...
libsharp, C, C++ and F90 packages, and are initially located respectively in
...
\htmladdnormallink{https://www.freedesktop.org/wiki/Software/pkg-config/}{%
...
%
      \item {\bf GNU Fortran 95} compiler (\texttt{gfortran}) included in GNU Compiler Collection {\em GCC} version 4.0.0
         ...
         \hfill \\
          \htmladdnormallink{\texttt{https://www.gnu.org/software/gcc/fortran/}}{https://www.gnu.org/software/gcc/fortran/}. \hfill \\
         GFortran binaries for all platforms can also be downloaded from  \hfill \\
          \htmladdnormallink{\texttt{https://gcc.gnu.org/wiki/GFortranBinaries}}{https://gcc.gnu.org/wiki/GFortranBinaries}. \hfill \\
...
\htmladdnormallink{\texttt{https://www.scivision.co/flang-compiler-build-tips}}{https://www.scivision.co/flang-compiler-build-tips} \hfill \\
and as source files for all platforms \hfill \\
\htmladdnormallink{\texttt{https://github.com/flang-compiler/flang/wiki/Building-Flang}}{https://github.com/flang-compiler/flang/wiki/Building-Flang}.
%
...
\item
  ...
  (\htmladdnormallink{https://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/cfitsio\_latest.tar.gz}{https://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/cfitsio\_latest.tar.gz}).
...
\item
  ...
  the version you installed):\\ 
	\mycode{\textbf{\$} cd Healpix\_3.60\_*}\\ 
	\mycode{\textbf{\$} cd Healpix\_3.60}\\ 
...
\htmladdnormallink{\texttt{https://gcc.gnu.org/wiki/GFortranBinaries}}{%
...
\htmladdnormallink{\texttt{\gdlsite}}{\gdlsite}).
...
\htmladdnormallink{\texttt{\gdlsite/issues}}{\gdlsite/issues}.}. 
...
\subsection{Bug corrections and Improvements in Version \hpxversion}%2018-11
...
% \subsubsection[General]{General}
% \begin{itemize}
% \item new \healpix web site \url{\hpxwebsite}
% \item addition of $\Lambda$-CDM best $C(\ell)$ fit to Planck 2018 CMB data in 
% \htmladdnormallink{\texttt{Healpix/test/planck2018\_lcdm\_cl\_v3.fits}}{\srcurl test/planck2018_lcdm_cl_v3.fits}
% \end{itemize}
...
%=========================================
%%%%%%%%%%%%%%%%%%%%%%%%%%----------------------------------------------------
\section{Appendix II: Older changes (versions 3.00 to 3.40)}
