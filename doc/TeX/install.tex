...
\newcommand{\healpixmail}{{\em healpix} {\tt at} {\em jpl.nasa.gov}}
...
\subsection{Bug corrections and Improvements in Version 3.1}
...
\subsubsection[Fortran]{%
	...
	\linklatexhtml{subroutines}{subroutines.pdf}{subroutines.htm}}
\begin{itemize}
	\item all Fortran facilities now support {\tt cfitsio}'s ``Extended File
Name Syntax''
allowing the reading and processing of an arbitrary HDU and table column out of a
FITS file. For example, setting \hfill \\
{\tt infile = }{\tt ftp://}{\it url/file.fits}{\tt .gz}{\tt [}{\it extname}{\tt
]}{\tt [col }{\it colname}{\tt ]}  \hfill \\
in {\tt anafast} 
will download the FITS file {\it file.fits.gz} from {\it url}, 
uncompress it, open the HDU (extension) with keyword {\tt EXTNAME =}{\it
extname}, read the table column with {\tt TTYPE*=}{\it colname} out of it and will
analyze it.
	\item 	still faster 
...
libsharp}}{http://sourceforge.net/projects/libsharp} routines
\end{itemize}
...
{\mytiny{%
\tinysubsection{Bug corrections and Improvements in Version 3.0} % 2012-11-27?
