...
\htmladdnormallink{{\tt http://gnudatalanguage.sourceforge.net/support.php}}{http://gnudatalanguage.sourceforge.net/support.php}.}. 
...
\begin{itemize}
\item they won't produce \mylinkext{idl:mollview:gif}{GIF} files (because GDL's {\tt write\_gif} is not yet functional), {\em Fixed in GDL v0.9.7}; 
...
%
\item \htmlref{{\tt median\_filter}}{fac:median_filter} facility: faster by moving an internal array from heap to stack;
...
see note on {\tt POLCCONV} in F90 facilities above.
\end{itemize}
