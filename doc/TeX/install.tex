...
\subsection{Bug corrections and Improvements in Version \hpxversion}%(2014-12)
...
\subsubsection[C++]{C++}
\begin{itemize}
\item deprecation of {\tt alice2}, replaced by {\tt alice3}
...
modules, ... produced during the compilation of the source codes
	\item \textbf{??? How about different parsing of B(l) files in {\tt synfast, smoothing, ...} ???}
	\item \textbf{??? Long string keywords ???}
\end{itemize}
