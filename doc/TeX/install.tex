...
\subsubsection[General]{General}
	...
	\item Interactive {\tt configure} script now supports MINGW (for Windows), 
		and better detects {\tt gcc} and {\tt python} versions
	\item Improved cross-document links of PDF documentation
	\end{itemize}
% \subsubsection[C]{\linklatexhtml{C}{csub.pdf}{csub.htm}}
\subsubsection[C++]{\htmladdnormallink{C++}{http://healpix.sourceforge.net/html/index_cxx.htm}}
	Removal of C99 features introduced in Version 3.30
\subsubsection[Fortran]{%
 	Fortran 90 \linklatexhtml{facilities}{facilities.pdf}{facilities.htm} and
 	\linklatexhtml{subroutines}{subroutines.pdf}{subroutines.htm}}
	Bug correction of input\_map routine for reading polarized multi-HDU cut sky FITS files
	Introduction of {\tt winfiledir\_*} and {\tt windowfile\_*} in \htmlref{{\tt alteralm}}{fac:alteralm} facility
\subsubsection[IDL]{\linklatexhtml{IDL}{idl.pdf}{idl.htm}}
	Improved support for GDL (see \htmlref{Using GDL instead of IDL}{install:using_gdl})
% \subsubsection[Java]{\htmladdnormallink{Java}{http://healpix.sourceforge.net/html/java/index.html}}
% \subsubsection[Python]{\htmladdnormallink{Python}{http://healpy.readthedocs.org/en/latest/}}
...
\tinysubsection{Bug corrections and Improvements in Version 3.30}%(2015-10-08)
\tinysubsubsection[C++]{\htmladdnormallink{C++}{http://healpix.sourceforge.net/html/index_cxx.htm}}
\begin{itemize}
...
\tinysubsubsection[Python]{\htmladdnormallink{Python}{http://healpy.readthedocs.org/en/latest/}}
\begin{itemize}
