...
\item the routines 
 ...
 \htmlref{\texttt{map2alm\_spin}}{sub:map2alm_spin} now calls the faster
 \htmlref{\texttt{alm2map}}{sub:alm2map} and 
 \htmlref{\texttt{map2alm}}{sub:map2alm} when invoked with a vanishing spin ($s=0$), 
 while keeping the spin-specific sign convention,
% \item the routines 
%  \htmlref{\texttt{alm2map\_spin}}{sub:alm2map_spin} and 
%  \htmlref{\texttt{map2alm\_spin}}{sub:map2alm_spin} now runs only for spin values $|s|>0$ 
%  (the faster routines 
%  \htmlref{\texttt{alm2map}}{sub:alm2map} and 
%  \htmlref{\texttt{map2alm}}{sub:map2alm} should be used instead when $s=0$),
