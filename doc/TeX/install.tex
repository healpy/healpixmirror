...
\subsubsection[Fortran]{%
	...
	\linklatexhtml{subroutines}{subroutines.pdf}{subroutines.htm}}
\begin{itemize}
\item  \htmladdnormallink{improved support of ifort18}{https://sourceforge.net/p/healpix/bugs/78} in \texttt{configure} script
\end{itemize}

%
\subsubsection[IDL]{\linklatexhtml{IDL}{idl.pdf}{idl.htm}}
\begin{itemize}
\item \htmlref{{\tt fits2cl}}{idl:fits2cl}: addition of \mylinkext{idl:fits2cl:planck3}{{\tt /PLANCK3}} keyword
to read best fit $C(\ell)$ model to Planck 2018 data;
\item \htmlref{rotate\_coord}{idl:rotate_coord}: addition of optional variable \mylinkext{idl:rotate_coord:delta_psi}{{\tt Delta\_Psi}} containing rotation of polarization on output, and of keyword \mylinkext{idl:rotate_coord:free_norm}{{\tt Free\_Norm}} to deal with un-normalized input coordinate vectors;
\item minor bugs correction in 
\texttt{azeqview, cartview, gnomview, mollview, orthview}}{idl:mollview} (when \texttt{polarization=3}}) and 
\texttt{alm2fits}{idl:alm2fits} (user provided header now correctly processed).
\end{itemize}
%
% \subsubsection[Java]{\htmladdnormallink{Java}{\healpixwebpage/html/java/index.html}}
%
...
\subsection{Bug corrections and Improvements in Version 3.40 (2018-06)}%(2018-06-22)
...
%
\subsubsection[Fortran]{Fortran 90 \linklatexhtml{facilities}{facilities.pdf}{facilities.htm} and
	\linklatexhtml{subroutines}{subroutines.pdf}{subroutines.htm}}
\begin{itemize}
\item The facilities 
