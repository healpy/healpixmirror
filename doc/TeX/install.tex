...
sourced as described in \S~\ref{subsub:conf}, the aliases {\tt hidl}, {\tt hgdl} and {\tt hidle}
are also defined to give you access to HEALPIX routines from IDL (or GDL).\\
...
IDL (resp GDL) should be tested by invoking {\tt hidl} or {\tt hidlde}  (resp {\tt hgdl}).
...
Some of the caveats and limitations detailled above, and others not listed here, 
are still present in GDL 0.9.4 (Sept 2013) and 0.9.5 (Oct 2014).
However, they are clearly identified and actively looked at by the GDL development team and 
should be fixed in the forthcoming GDL 0.9.6.
