...
output files, and with \htmladdnormallink{\tt pslib}{http://pslib.sourceforge.net} to produce PostScript and PDF files (in the latter case,
...
\begin{itemize}
\item they won't produce GIF files (because GDL's {\tt WRITE\_GIF} is not yet functional); 
\item the \mylinkext{idl:mollview:transparent}{\tt transparent} keyword will be ignored in the
production of PNG files under GDL (except when \mylinkext{idl:mollview:truecolors}{\tt TrueColors} is set and $N$x3 map is provided), and for the same reason, the \htmlref{\tt hpx2gs}{idl:hpx2gs} routine won't mark missing pixels as
...
\end{itemize}
All other features work properly.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%----------------------------------------------------
\section{Appendix II: Older changes (versions 3.00 to 3.20}
