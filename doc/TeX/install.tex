...
GDL \gdlversion\ or more         & 
                            \htmladdnormallink{{\tt
                            https://sf.net/projects/gnudatalanguage}}{%
			    https://sf.net/projects/gnudatalanguage}
                                                      \\ %%% for presentation
...
\htmladdnormallink{\texttt{Healpix\_\hpxversion/test/}}{https://sourceforge.net/p/healpix/code/HEAD/tree/trunk/test}
...
% \subsubsection[Python]{\htmladdnormallink{Python}{https://healpy.readthedocs.org/en/latest/}}
...
The weights for power-of-2 values of $\nside$ in $\{16,\ldots,2048\}$ are precomputed and shipped in \htmladdnormallink{\texttt{Healpix/data/weight\_pixel\_n?????.fits}}{https://sourceforge.net/p/healpix/code/HEAD/tree/trunk/data}, and the missing ones can be computed for any value of $\nside$ with the \texttt{compute\_weights} C++ facility.
...
\tinysubsubsection*{\htmladdnormallink{Python}{https://healpy.readthedocs.org/en/latest/}}
	\begin{itemize}
	\item Switch to 
