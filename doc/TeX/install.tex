...
\subsection{Bug corrections and Improvements in Version 3.11}
...
can now be compiled with any {\tt gcc} version.
	\item bug correction in \htmlref{{\tt query\_disc}}{sub:query_disc} in {\tt inclusive}
mode
	\item bug correction in \htmlref{{\tt alm2map\_spin}}{sub:alm2map_spin} routine,
which had its {\tt spin} value set to 2
\end{itemize}
%
\subsubsection[IDL]{\linklatexhtml{IDL}{idl.pdf}{idl.htm}}
\begin{itemize}
...
% \subsubsection[Python]{Python}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% END LATEST CHANGES %%%%%%%%%%%%%
\subsection{Bug corrections and Improvements in Version 3.10}
\subsubsection[General]{General}
N/A%
\subsubsection[C]{\linklatexhtml{C}{csub.pdf}{csub.htm}}
%
...
\tinysubsubsection[Fortran 90 facilities and subroutines]{%
Fortran 90 \linklatexhtml{facilities}{facilities.pdf}{facilities.htm} and
\linklatexhtml{subroutines}{subroutines.pdf}{subroutines.htm}
}
\begin{itemize}
