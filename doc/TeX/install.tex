...
For instance, in Bourne related shell (eg, \texttt{sh, bash, dash, ksh, zsh}), the command\\
\texttt{FC=ifort CC=icc ./configure}\\
and in C related shell (eg, \texttt{csh, tcsh})\\
\texttt{setenv FC ifort ; setenv CC icc ; ./configure}\\
will run the \texttt{configure} script with the Intel fortan and C compilers proposed as default.
...
\item The interactive \mylink{install:configure}{\texttt{configure}} script will ensure
