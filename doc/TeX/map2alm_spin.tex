...
highly recommended, and much more memory-efficient, to use directly the routine \htmlref{map2alm}{sub:map2alm}, rather then setting \mylink{sub:alm2map_spin:spin}{\texttt{spin}}$=0$ in \thedocid.
}
{\modAlmTools}
\end{facility}
