...
match \healpix polarization $a^E, a^B, Q$ and $U$ respectively. \textbf{However}, for
...
highly recommended, and much more memory-efficient, to use directly the routine \htmlref{alm2map}{sub:alm2map}, rather then setting \mylink{sub:alm2map_spin:spin}{\texttt{spin}}$=0$ in \thedocid.
}
{\modAlmTools}
\end{facility}
...
Note: Starting with \htmlref{version 3.80}{sub:new3p80}, some {\tt libsharp} routines will be called for any $|s|$ value.
\end{modules}
