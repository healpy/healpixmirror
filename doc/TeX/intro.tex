...
(or quad-sphere, see 
\htmladdnormallink{\texttt{https://lambda.gsfc.nasa.gov/\-product/\-cobe/skymap\_info\_new.cfm}}
...
FITS I/O interfaces 
(\htmladdnormallink{\texttt{https://heasarc.gsfc.nasa.gov/docs/software/fitsio}}
...
https://map.gsfc.nasa.gov/news/index.html}}{https://map.gsfc.nasa.gov/news/index.html})
...
(see \htmladdnormallink{\texttt{https://www.cosmos.esa.int/web/planck}}%
...
% \textbf{Boomerang}
% (see \htmladdnormallink{\texttt{http://cmb.PHYS.cwru.edu/boomerang/}}
% {http://cmb.PHYS.cwru.edu/boomerang/} or 
% \htmladdnormallink{\texttt{http://oberon.roma1.infn.it/\-boomerang/}}
% {http://oberon.roma1.infn.it/boomerang/})
% and \textbf{Archeops} (
% \htmladdnormallink{\texttt{http://archeops01.free.fr/\-main\_archeops/\-index\_english.html}}
...
Fortran90 facility \htmlref{\texttt{anafast}}{fac:anafast}, included in the
package. 
...
(\htmladdnormallink{\texttt{https://lambda.gsfc.nasa.gov/toolbox/tb\_cmbfast\_ov.cfm}}
...
\begin{itemize}
\item \texttt{camb} (\htmladdnormallink{\texttt{https://camb.info}}{https://camb.info}) 
...
\item \texttt{class} (\htmladdnormallink{\texttt{http://class-code.net}}{http://class-code.net}) 
...
\;_{s_2} Y_{lm}(\vecn_2)&\myequal&\sqrt{2l+1 \over 4 \pi} 
...
Finally, 
the IDL subroutine \htmlref{\texttt{change\_polcconv.pro}}{idl:change_polcconv} 
...
in Fortran90 and C++. 
It resides in 
%\htmladdnormallink{\texttt{src/f90/mod/rngmod.f90}}{https://sourceforge.net/p/healpix/code/HEAD/tree/trunk/src/f90/mod/rngmod.f90}
\htmladdnormallink{\texttt{src/f90/mod/rngmod.f90}}{\srcurl src/f90/mod/rngmod.f90}
and 
%\htmladdnormallink{\texttt{src/cxx/cxxsupport/planck\_rng.h}}{https://sourceforge.net/p/healpix/code/HEAD/tree/trunk/src/cxx/cxxsupport/planck_rng.h}
...
%\htmladdnormallink{\texttt{src/f90/mod/ran\_tools\_dist.f90}}{https://sourceforge.net/p/healpix/code/HEAD/tree/trunk/src/f90/mod/ran_tools_dist.f90}). 
...
(cf. \htmladdnormallink{\texttt{https://www.cs.hku.hk/}}{https://www.cs.hku.hk/}).
