...
When dealing with a polarized (full-sky or cut-sky) signal map, 
the F90 subroutine \htmlref{\texttt{input\_map}}{sub:input_map} and the facilities 
...
- issue a warning, and \emph{swap the sign of the $U$ polarisation} stored into memory if the FITS file being read contains \texttt{POLCCONV='IAU'}, \\
...
The IDL facility \htmlref{\texttt{change\_polcconv}}{idl:change_polcconv} is provided to add this keyword or
