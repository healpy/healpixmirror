...
and the facilities calling it and dealing with the $I$, $Q$ and $U$ Stokes parameters as a whole, {\em ie}
\htmlref{\texttt{anafast}}{fac:anafast} and
...
On the other hand, routines treating each of $I$, $Q$ and $U$ fields separately , such as the F90 facilities
