...
The full-fledged \healpix software package described above is available under 
\htmladdnormallink{version 2 of the GNU General Public License (GPLv2)}{https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html}
and can be downloaded from 
\url{https://sourceforge.net/projects/healpix/files/latest/download}.\\
\\
Beside this, a subset of C routines, called \texttt{healpix\_bare} and providing support for back and forth conversion between
...
\htmladdnormallink{3-clause BSD license}{https://opensource.org/licenses/BSD-3-Clause}.
