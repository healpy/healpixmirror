...
\newcommand{\npix}{N_{\textrm{pix}}}
\newcommand{\Opix}{\Omega_{\textrm{pix}}}
\newcommand{\nside}{N_{\textrm{side}}}
...
All pixel centers are located on $N_\textrm{ring} = 4 \times \nside - 1$ rings of 
constant latitude.
...
\begin{eqnarray}
	\nside &\myequal& 2^{\textrm{floor}\left( \log_2(u/4)/2 \right)}, \myhtmlimage{} \label{eq:ring2nest_a}\\
...
\label{subsec:pol}
\newcommand{\Cl}[1]{C_{\ell}^\textrm{#1}}
\newcommand{\Chl}[1]{C_{\ell}^\textrm{#1}}
\newcommand{\Czl}[1]{C_\textrm{#1},\ell}
\newcommand{\alm}[1]{a_{\ell m}^\textrm{#1}}
\newcommand{\azlm}[1]{a_\textrm{#1},\ell m}
...
pixelated map, $C_{\ell}^{\textrm{pix}}$, is related to the hypothetical unpixelated
one, $C_{\ell}^{\textrm{unpix}}$, by 
\begin{eqnarray}
