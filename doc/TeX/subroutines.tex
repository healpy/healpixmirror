...
%--------------------------------------------
%--------------------------------------------
\section[Changes between releases 2.20 and 2.??]{Changes between releases 2.20 and
2.??}
\label{sub:new2p30}
\begin{itemize}
\item \htmlref{dist2holes\_nest}{sub:dist2holes_nest}, \htmlref{fill\_holes\_nest}{sub:fill_holes_nest}
\end{itemize}
