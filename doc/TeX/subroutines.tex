...
%-------------------------------------------- CHANGES
%--------------------------------------------
\section[Changes between releases 3.60 and \hpxversion]{Changes between releases 3.60 and
\hpxversion} %2020-??
\label{sub:new3p70}
\begin{itemize}
...
%--------------------------------------------
%--------------------------------------------
\subsection[Changes between releases 3.00 and 3.60]{Changes between releases 3.00 and 3.60}
%--------------------------------------------
