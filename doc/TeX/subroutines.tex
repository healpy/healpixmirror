...
\include{input_map}
\include{input_tod}
\include{long_intrinsic} % special format
\include{map2alm}
...
\include{output_map}
\include{parse_xxx} % special format
\include{pixel_window}
\include{pix_tools} % special format
\include{planck_rng}
\include{plm_gen}
\include{query_disc}
...
\include{rotate_alm}
\include{same_shape_pixels_xxx}% special format
\include{scan_directories}
\include{size_holes_nest}
\include{string}
\include{surface_triangle}
\include{template_pixel_xxx}% special format
