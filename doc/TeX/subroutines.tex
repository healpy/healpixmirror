...
%-------------------------------------------- CHANGES
%--------------------------------------------
\section[Changes between releases 3.40 and \hpxversion]{Changes between releases 3.40 and
\hpxversion}
\begin{itemize}
\item correction of a bug in 
\htmlref{\texttt{map2alm\_iterative}}{sub:map2alm_iterative},
when a \mylink{sub:map2alm_iterative:mask}{\texttt{mask}} is used in combination with 
\item addition of \mylink{sub:alm2map:zbounds}{\texttt{zbounds}} 
  in \htmlref{\texttt{alm2map}}{sub:alm2map} 
...
\section[Changes between releases 3.31 and 3.40]{Changes between releases 3.31 and
3.40}
\begin{itemize}
\item The facilities 
