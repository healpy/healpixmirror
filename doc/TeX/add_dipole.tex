...
\begin{f90format}
{\mylink{sub:add_dipole:nside}{nside}%
, \mylink{sub:add_dipole:map}{map}%
, \mylink{sub:add_dipole:ordering}{ordering}%
, \mylink{sub:add_dipole:degree}{degree}%
, \mylink{sub:add_dipole:multipoles}{multipoles}%
 \optional{[, \mylink{sub:add_dipole:fmissval}{fmissval}%
]}}
\end{f90format}
\aboutoptional
