...
\begin{itemize}
	...
	%\item improved \htmlref{{\tt repeat}}{sub:write_bintabh} behavior in \htmlref{{\tt write\_bintabh}}{sub:write_bintabh} routine
	%\item patched \htmlref{{\tt map2alm\_iterative}}{sub:map2alm_iterative} for a bug in Intel Ifort 15.0.2
\end{itemize}
