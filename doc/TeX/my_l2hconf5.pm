...
$PDFLATEX = '/usr/local/texlive/2018/bin/x86_64-darwin/pdflatex';	# pdfLaTeX
$LUALATEX = '/usr/local/texlive/2018/bin/x86_64-darwin/lualatex';	# LuaLaTeX
$DVILUALATEX = '/usr/local/texlive/2018/bin/x86_64-darwin/dvilualatex';	# dviLuaLaTeX
$DVIPS = '/usr/local/texlive/2018/bin/x86_64-darwin/dvips';	# dvips
$DVIPNG = '/usr/local/texlive/2018/bin/x86_64-darwin/dvipng';	# dvipng
$PDFTOCAIRO = '';	# pdf to svg converter
$PDFCROP = '/usr/local/texlive/2018/bin/x86_64-darwin/pdfcrop';	# pdfcrop
$GS = '/usr/local/bin/gs';	# GhostScript
...
$INILATEX = "/usr/local/texlive/2018/bin/x86_64-darwin/initex \"&latex\"";	# initex+latex
...
#
$TEXEXPAND = "$PERL /usr/local/latex2html_git/install/bin${dd}texexpand";


# Location of pstoimg, supplied with the translator
#
$PSTOIMG = "$PERL /usr/local/latex2html_git/install/bin${dd}pstoimg";
...
#
$RGBCOLORFILE = '/tmp/share/lib/latex2html/styles/rgb.txt';

# the CMYK colors database
#
$CRAYOLAFILE = '/tmp/share/lib/latex2html/styles/crayola.txt';
...
# 
#$WORDS_IN_NAVIGATION_PANEL_TITLES = 4;  #EFH
