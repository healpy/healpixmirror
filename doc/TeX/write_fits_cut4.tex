...
coord(LEN=1) \hskip 2cm (OPTIONAL)      & CHR & IN &   astrophysical coordinates ('C' or 'Q'
...
header(LEN=80) \hskip 2cm (OPTIONAL)    & CHR & IN &   FITS header to be included in the FITS file\\
units(LEN=20)\hskip 2cm (OPTIONAL) & CHR & IN &  maps units (applies only to Signal and
                   Serror)\\
extension \ (OPTIONAL)    & I4B & IN & (0 based) extension number in which to write data. \default{0}.
...
Order and Coord \\
polarisaton \ (OPTIONAL) & I4B & IN & if set to a non zero value, specifies that file will contain the I, Q and U polarisation
