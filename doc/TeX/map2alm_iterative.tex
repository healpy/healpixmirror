...
\\
In \htmlref{version 3.50}{sub:new3p50} a bug affecting the result of \thedocid when a non-boolean \mylink{sub:map2alm_iterative:mask}{mask} (different from 0 or 1) 
was used in conjunction with \mylink{sub:map2alm_iterative:iter_order}{iter\_order}$>0$
has been fixed.
}
{\modAlmTools}
\end{facility}
