...
map\_in\mytarget{sub:udgrade_nest:map_in}(0:12*nside\_in**2-1,1:nd) & SP/ DP & IN & bi-dimensional full sky map to be
...
map\_out\mytarget{sub:udgrade_nest:map_out}(0:12*nside\_out**2-1,1:nd) & SP/ DP & OUT & bi-dimensional full sky map after
