...
\htmlref{{\tt outline\_earth}}{idl:outline_earth}
%
\item Color table creation: \htmlref{{\tt planck\_colors}}{idl:planck_colors}
%
...
\htmlref{{\tt nside2npweights}}{idl:nside2npweights},
\htmlref{{\tt unfold\_weights}}{idl:unfold_weights}.
...
\htmlref{{\tt read\_fits\_partial}}{idl:read_fits_partial},
...
\htmlref{{\tt write\_fits\_partial}}{idl:write_fits_partial}, 
...
\htmlref{\tt uniq2nest}{idl:uniq2nest},
\htmlref{\tt nest2uniq}{idl:nest2uniq}
%
...
\htmlref{{\tt nside2ntemplates}}{idl:nside2ntemplates},
...
\htmlref{{\tt init\_healpix}}{idl:init_healpix}
\item online documentation: \htmlref{{\tt healpix\_doc}}{idl:healpix_doc}
\item recursive {\tt help} on IDL sub-structures: \htmlref{{\tt help\_st}}{idl:help_st}
\end{itemize}
