...
-- If the index does not match any existing table, or if it is above 255, 
  the current online table (modifiable with \htmlref{{\tt planck\_colors}}{idl:planck_colors}, {\tt TVLCT}, {\tt XLOADCT}, {\tt XPALETTE}, ... 
  or eg, J. Davenport's 
\htmladdnormallink%
{{\tt cubehelix.pro}}%
...
% {/ONLINE}  & \mylink{idl:mollview:routines}{all}  & \parbox[t]{\hsize}{
