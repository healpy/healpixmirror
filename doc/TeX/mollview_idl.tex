...
and/or \htmladdnormallink{ImageMagick {\tt convert}}{http://www.imagemagick.org/script/index.php} 
can be used to turn a PS or PDF file into high resolution GIF, JPEG or PNG file.\\
        - otherwise (for X, \mylink{idl:mollview:png}{PNG}, \mylink{idl:mollview:jpeg}{JPEG} or \mylink{idl:mollview:gif}{GIF} outputs) LaTeX is partially emulated with \htmladdnormallink{\tt TeXtoIDL}{http://physics.mnstate.edu/craig/textoidl/} routines now shipped with \healpix
