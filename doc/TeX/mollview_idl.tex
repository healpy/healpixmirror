...
{\tt CBAR.SPACES, CBAR.TY}: 3-element vector listing the strings to be inserted between the map minimum value label, the color bar, the map maximum value, and the map units (read from the FITS file or provided by \mylink{idl:mollview:units}{UNITS}): \default{3 single spaces}, and vertical offset of the text (min, max and units labels) with respect to the color bar \default{0};
the character size of the text accompanying the color bar is fully determined by the keyword \mylink{idl:mollview:charsize}{Charsize},\\
...
{\tt VSCALE.X, VSCALE.Y}: X,Y location of scale calibrating the polarization rods (whose length and spacing can be tuned with \mylink{idl:mollview:polarization}{POLARIZATION=[3, length, spacing]})\\
...
As shown in \mylink{idl:mollview:example7}{Example \#7} \latexhtml{on page~\pageref{page:moll_customize}}{below}, the returned structure can be inspected with the routine \htmlref{help\_st}{idl:help_st}.}\\
...
\hspace{3em}  title:\{x:0,charsize:2\}\} \\
%,png='~/healpix_svn/doc/TeX/fig/moll_customize.png',/preview
 \htmlref{help\_st}{idl:help_st}, dsmoll
\\
\end{tabular}
}
{\parbox[t]{\hsize}{will generate a Mollweide projection plot with customized thickness and length of the color bar, 
...
\hspace{1em}      .ASPOS.X                   \hspace{2em}         FLOAT   \hspace{2em}        -1.00000\\
\hspace{1em}      .ASPOS.Y                   \hspace{2em}         FLOAT   \hspace{2em}        -1.00000\\
\hspace{1em}      .CBAR.DX                   \hspace{2em}         FLOAT   \hspace{2em}        0.333333\\
\hspace{1em}      .CBAR.DY                   \hspace{2em}         FLOAT   \hspace{2em}       0.0142857\\
\hspace{1em}      .CBAR.SPACES               \hspace{2em}         STRING  \hspace{2em}   Array[3]\\
\hspace{1em}      .CBAR.TY                   \hspace{2em}         FLOAT   \hspace{2em}         0.00000\\
\hspace{1em}      .CRING.DX                  \hspace{2em}         FLOAT   \hspace{2em}        0.100000\\
\hspace{1em}      .CRING.XLL                 \hspace{2em}         FLOAT   \hspace{2em}       0.0250000\\
\hspace{1em}      .CRING.YLL                 \hspace{2em}         FLOAT   \hspace{2em}       0.0250000\\
\hspace{1em}      .SUBTITLE.X                \hspace{2em}         FLOAT   \hspace{2em}        0.500000\\
\hspace{1em}      .SUBTITLE.Y                \hspace{2em}         FLOAT   \hspace{2em}        0.905000\\
\hspace{1em}      .SUBTITLE.CHARSIZE         \hspace{2em}         FLOAT   \hspace{2em}         1.20000\\
\hspace{1em}      .TITLE.X                   \hspace{2em}         FLOAT   \hspace{2em}        0.500000\\
\hspace{1em}      .TITLE.Y                   \hspace{2em}         FLOAT   \hspace{2em}        0.950000\\
\hspace{1em}      .TITLE.CHARSIZE            \hspace{2em}         FLOAT   \hspace{2em}         1.60000\\
\hspace{1em}      .VSCALE.X                  \hspace{2em}         FLOAT   \hspace{2em}       0.0500000\\
\hspace{1em}      .VSCALE.Y                  \hspace{2em}         FLOAT   \hspace{2em}       0.0200000
}}
}}
\end{examples}
%
\begin{figure}[h!]
\latexhtml{%for latex
\centerline{\includegraphics[width=0.60\textwidth]{fig/moll_customize}}
}{%for html
\centerline{\includegraphics[width=520pt]{fig/moll_customize}{}}
}
\caption{%
