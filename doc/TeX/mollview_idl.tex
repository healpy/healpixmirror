...
{BAD\_COLOR=}\mytarget{idl:mollview:bad_color}  & all  & 
...
{BG\_COLOR=}\mytarget{idl:mollview:bg_color}  & all   &  
...
{FG\_COLOR=}\mytarget{idl:mollview:fg_color}  & all   &  
...
{JPEG=}\mytarget{idl:mollview:jpeg}  & all   & \parbox[t]{\hsize}{
...
{PYSIZE=}\mytarget{idl:mollview:pysize}  & ACG--   & \parbox[t]{\hsize}{
...
{RESO\_ARCMIN=}\mytarget{idl:mollview:reso_arcmin} & ACG-- &  \parbox[t]{\hsize}{
...
{STAGGER=}\mytarget{idl:mollview:stagger}  & ---O   & \parbox[t]{\hsize}{
