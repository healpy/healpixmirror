...
nmaps     & I4B & IN &  number of maps in the file  \\
                   &   &   &                           \\ %%% for presentation
fmissval \hskip 3cm (OPTIONAL) & SP/ DP & IN &  value to be given to missing pixels, its default
                   value is 0 \\
header(LEN=80)(1:) \hskip 3cm (OPTIONAL)    & CHR & OUT &   FITS extension header \\
units(LEN=20)(1:nmaps) \hskip 3cm (OPTIONAL) & CHR & OUT &  maps units \\
extno \hskip 4cm (OPTIONAL) & I4B & IN & extension number to read the data from
