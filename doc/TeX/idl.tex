...
\begin{itemize}
	...
	\item addition of the \mylink{idl:mollview:silhouette}{{\tt SILHOUETTE}} keyword to add a tunable silhouette around the projected map
        (\htmlref{{\tt azmollview and orthview only}}{idl:mollview})
\end{itemize}
