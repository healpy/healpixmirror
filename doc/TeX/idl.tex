...
\section{Changes in release \hpxversion} %2022-07-27
%--------------------------------
\begin{itemize}
%--------------------------------
...
{\mysmaller%% (itemize)
\compresstext
\subsubsection{Changes between release 3.70 and 3.80}%2021-06
%--------------------------------
\begin{itemize}\compresslist %--------0
%--------------------------------
\item Improvement to the \htmlref{\texttt{query\_disc}}{idl:query_disc} routine in \mylink{idl:query_disc:inclusive}{{\tt inclusive}} mode;
\item update of the required
    \htmladdnormallink{\texttt{IDL-astron} library}{https://idlastro.gsfc.nasa.gov/homepage.html}
    routines, and \htmladdnormallink{\texttt{Coyote}}{http://www.idlcoyote.com} library
    routines (2021-04-08).%
...
\subsubsection{Changes between release 3.60 and 3.70}%2020-07
%--------------------------------
\begin{itemize}\compresslist %--------0
%--------------------------------
\item Addition of 
