...
\section{Changes in release \hpxversion}%2019-03?
%--------------------------------
\begin{itemize}
%--------------------------------
\item addition of \htmlref{\texttt{outline\_earth}}{idl:outline_earth} to create a structure outline Earth features, such as coastlines, rivers, country boundaries, ...
...
{\mysmaller%
\compresstext
\subsubsection{Changes between release 3.40 and 3.50}%2018-12
%--------------------------------
\begin{itemize}
%--------------------------------
...
{\mysmaller%
\compresstext
\subsubsection{Changes between release 3.31 and 3.40}%2018-06
%--------------------------------
\begin{itemize}
%--------------------------------
