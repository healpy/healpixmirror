...
\section{Changes between releases 3.40 and \hpxversion}
%--------------------------------
\begin{itemize}
%--------------------------------
\item \htmlref{{\tt fits2cl}}{idl:fits2cl}: addition of \mylink{idl:fits2cl:planck3}{{\tt /PLANCK3}} keyword
to read best fit $C(\ell)$ model to Planck 2018 data;
\item \htmlref{rotate\_coord}{idl:rotate_coord}: addition of optional variable \mylink{idl:rotate_coord:delta_psi}{{\tt Delta\_Psi}} containing rotation of polarization on output, and of keyword \mylink{idl:rotate_coord:free_norm}{{\tt Free\_Norm}} to deal with un-normalized input coordinate vectors
%--------------------------------
\end{itemize}
%--------------------------------


\section{Changes between releases 3.31 and 3.40}%2018-06
%--------------------------------
\begin{itemize}
%--------------------------------
