...
(\htmladdnormallink{%
http://cow.physics.wisc.edu/{\textasciitilde}craigm/idl/idl.html}{%
...
See the section ''\htmlref{Using GDL instead of IDL}{install:using_gdl}'' in \linklatexhtml{the Installation Document}{install.pdf}{install.htm} for more information on this topic.
...
\begin{itemize}
\item new \htmlref{help\_st}{idl:help_st}
